...
**ForlornKnight** is a story-rich 2D action-adventure game built in **Godot Engine**, following the journey of a nameless knight; a lone wanderer on a seemingly futile quest in a withering world, haunted by the past and burdened by prophecy.
...
Expect (or maybe not) regular updates on art, story chapters, and core mechanics.

## Contributing

This is a solo/indie project for now. Feel free to open issues or suggestions.
